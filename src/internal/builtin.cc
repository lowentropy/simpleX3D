...
void Builtin::init(Profile* profile) {
    ...
    Component* interp = profile->createComponent("Interpolation");
    {
        ...
        NodeDefImpl<PositionInterpolator>* pi =
            interp->createNode<PositionInterpolator>("PositionInterpolator");
        {
            pi->inherits("X3DInterpolatorNode");
